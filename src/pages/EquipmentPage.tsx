...
export function EquipmentPage() {
  ...
  return <div className="space-y-6"><div className="flex items-end justify-between"><div><h1 className="pt-page-title">Equipamentos</h1><p className="pt-page-subtitle">Prontuário técnico por cliente e número de série.</p></div>{can(user, "equipment.manage") && <button className="pt-btn-primary" onClick={() => setOpen((v) => !v)}>+ Novo equipamento</button>}</div>
