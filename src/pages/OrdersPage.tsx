...
const statusOptions: Array<{
  ...
  {
    value: 'ready_for_commercial',
    label: 'Pronto para comercial',
  },
  {
    ...
    <>
      ...
      {error && (
        ...
        >
          <div>
            <strong>
              Não foi possível carregar todas as Ordens de Serviço
            </strong>
      ...
      <section className="panel">
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p>
              Abra uma nova OS ou altere os filtros da busca.
            </p>
          </div>
        ) : (
                ...
                {filteredOrders.map(
                  (order) => (
                    ...
                    >
                      ...
                      <td>
                        <span
                          className={`priority priority-${order.priority}`}
                        >
                          {
                            priorityLabels[
                              order
